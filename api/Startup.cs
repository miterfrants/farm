...
namespace Homo.FarmApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var secrets = (Homo.FarmApi.Secrets)appSettings.Secrets;
            services.AddDbContext<FarmDbContext>(options => options.UseMySql(secrets.DBConnectionString, serverVersion));
        ...
        )
        {
            ...
            app.UseRouting();
            app.UseMiddleware(typeof(FarmApiErrorHandlingMiddleware));
