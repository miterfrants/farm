...
(async () => {
    ...
    execSync('dotnet ef migrations add Article --context FarmDbContext');
    execSync('dotnet ef database update --context FarmDbContext');
    console.log('initialize Farm api finish');
})();
